...
// 元素与html对应的wxml标签名
const getWxmlTag = (tagStr) =>
  !tagStr ? undefined : correspondTag[tagStr] || 'view';
    ...
    arr.forEach((item) => {
      ...
      if (item.children) {
        eachFn(
          ...
          o,
          e,
          isRichTextContent || item.name === 'rich-text'
        );
      }
      child.push(o);
      child_e.push(e);
